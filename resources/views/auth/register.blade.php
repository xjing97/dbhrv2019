            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }}">
                            <label for="illness" class="col-md-4 control-label">Illness</label>

                            <div class="col-md-6">
                                <input id="illness" type="text" class="form-control" name="illness" value="{{ old('illness') }}" required autofocus>
